...
int t1() {
  ...
  struct bnt *t = rbi_create_tree(bn_node(n3));
...
int t3() {
  struct grbn *n1 = rbi_create_color_node(1, 3);
  struct grbn *n3 = rbi_create_color_node(3, RB_BLACK);
  struct grbn *n5 = rbi_create_color_node(5, RB_BLACK);
  bn_connect2(n3, left, n1, top);
  bn_connect2(n3, right, n5, top);
...
int t4() {
  ...
  struct grbn *n3 = rbi_create_color_node(3, RB_BLACK);
  struct grbn *n5 = rbi_create_color_node(5, RB_RED);
  struct grbn *n6 = rbi_create_color_node(6, RB_RED);
  bn_connect2(n3, left, n1, top);
  bn_connect2(n3, right, n5, top);
