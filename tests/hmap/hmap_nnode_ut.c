...
int main(int argc, char *argv[]) {
  ...
  hmap_insert(map, gtype_s(ext_strdup("bbb")), gtype_l(200));
  hmap_insert(map, gtype_s(ext_strdup("ccc")), gtype_l(300));
  hmap_insert(map, gtype_s(ext_strdup("ddd")), gtype_l(400));
  hmap_insert(map, gtype_s(ext_strdup("eee")), gtype_l(500));
  ...
  CHECK_MSG(map->noccupied == 5, "noccupied == 5");
  gtype *value = hmap_insert_free_key(map, gtype_s(ext_strdup("eee")), gtype_l(600)).value;
  CHECK_MSG(value->l == 500, "value eee == 500");
  hmap_insert(map, gtype_s(ext_strdup("fff")), gtype_l(700));
  hmap_insert(map, gtype_s(ext_strdup("ggg")), gtype_l(800));
  hmap_insert(map, gtype_s(ext_strdup("hhh")), gtype_l(900));
  hmap_insert(map, gtype_s(ext_strdup("iii")), gtype_l(1000));
  hmap_insert(map, gtype_s(ext_strdup("jjj")), gtype_l(1100));
  CHECK_MSG(hmap_size(map) == 8, "nnodes == 8");
  CHECK_MSG(map->noccupied == 8, "noccupied (sau resize) == 8");
  hmap_remove(map, gtype_s("eee"));
  value = hmap_insert_free_key(map, gtype_s(ext_strdup("eee")), gtype_l(600)).value;
