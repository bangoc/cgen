...
int t1() {
  ...
  CHECK_MSG(hset_insert(hs, gtype_s(strdup("ABC"))).inserted == 1, "Insert ABC");
  CHECK_MSG(hset_insert(hs, gtype_s(strdup("DEF"))).inserted == 1, "Insert DEF");
  CHECK_MSG(hset_insert(hs, gtype_s("ABC")).inserted == 0, "Duplicate ABC");
  CHECK_MSG(hset_insert(hs, gtype_s(strdup("DHF"))).inserted == 1, "Inserted DHF");
